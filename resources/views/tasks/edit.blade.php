            ...
            <div class="col-9">
                ...
                <div class="col">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control rounded-3" id="taskName" placeholder="Task Name" name="name" value="{{ $task->name }}">
                    </div>
                    ...
                    <div class="d-grid">
                        <button class="btn btn-outline-secondary rounded-3 mt-3" type="submit">Update Task</button>
                    </div>
                </div>
                <hr>
                <div class="mt-3">
